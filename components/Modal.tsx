...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div
        className="
        justify-center items-center overflow-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none
          ...
          <div className="h-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
            ...
            <div className="flex items-center justify-center p-10 rounded-t">
              ...
              <button
                ...
                "
              >
                <AiOutlineClose onClick={handleClose} color="white" />
              </button>
            </div>
            {/* body */}
